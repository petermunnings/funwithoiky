            ...
            using (var context = new oikonomosEntities(ConfigurationManager.ConnectionStrings["oikonomosEntities"].ConnectionString))
            {
                ...
                return (from p in personList
                        ...
                        select new PersonViewModel
                        {
                            ...
                            Occupation        = p.PersonOptionalFields.FirstOrDefault(c => c.OptionalFieldId == (int)OptionalFields.Occupation).Value,
                            MaritalStatus     = p.PersonOptionalFields.FirstOrDefault(c => c.OptionalFieldId == (int)OptionalFields.MaritalStatus).Value,
                            Site              = p.Site.Name,
